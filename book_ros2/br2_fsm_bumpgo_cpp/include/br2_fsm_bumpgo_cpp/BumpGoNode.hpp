...
private:
  ...
  const rclcpp::Duration TURNING_TIME {4.5s};
  const rclcpp::Duration BACKING_TIME {2s};
  const rclcpp::Duration SCAN_TIMEOUT {0.25s};

  static constexpr float SPEED_LINEAR = 0.045f;
  static constexpr float SPEED_ANGULAR = 0.25f;
  static constexpr float OBSTACLE_DISTANCE = 0.6f;
